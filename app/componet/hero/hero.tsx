...
const Hero = () => {
    ...
    <div className="pt-20 md:pt-32 space-y-4 md:space-y-6 -mt-24">
        <p className="text-lg md:text-xl font-serif text-purple-700 mb-4 md:mb-2">I am,</p>
        ...
        <p className="text-lg md:text-xl font-serif text-purple-700 sm:pl-16 md:pl-24">
            FullStack Developer based in Karachi
        </p>
